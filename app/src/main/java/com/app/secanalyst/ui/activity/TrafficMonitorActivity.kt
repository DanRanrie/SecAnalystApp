...
import com.app.secanalyst.ui.screens.TrafficMonitorScreen
import com.app.secanalyst.ui.theme.SecAnalystTheme

class TrafficMonitorActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            SecAnalystTheme(darkTheme = darkTheme) {
                TrafficMonitorScreen(onBack = { onBackPressedDispatcher.onBackPressed() })
            }
        }
    }
}
